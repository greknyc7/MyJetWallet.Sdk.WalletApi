...
namespace MyJetWallet.Sdk.WalletApi
{
    public static class StartupUtils
    {
            ...
            bool enableApiTrace, string swaggerOffsetName)
        {
            ...
            {
                options.RouteTemplate = $"swagger/{swaggerOffsetName}/_/{{documentName}}/swagger.json";
            });
            
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint($"/swagger/{swaggerOffsetName}/_/v1/swagger.json", $"Wallet API: {swaggerOffsetName}");
